...
JobGraph::Data::File - Output file object that implements JobGraph::Data interface

=head1 SYNOPSIS

    # Instantiate
    my $output = JobGraph::Data::File->new({
        NAME       => 'An identifier',
...
package JobGraph::Data::File;
use strict;

use base qw(JobGraph::Data);
