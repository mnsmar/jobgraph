...
JobGraph::Job::Executable - Abstract class for jobs which run an executable

=head1 SYNOPSIS

    # Should not be instantiated but if it was, the fields it supports are 
    my $executable = JobGraph::Job::Executable->new({
        INPUT        => [$input_obj],
        OUTPUT       => [$output_obj],
...
=head1 DESCRIPTION
    ...
    executable and catch its STDOUT and STDERR. It respects the interface of JobGraph::Job
...
package JobGraph::Job::Executable;
use strict;

use base qw(JobGraph::Job);
